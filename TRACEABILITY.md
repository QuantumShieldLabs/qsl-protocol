...
- NA-0167 implementation — soak harness defaults hardened for safe state-root + deterministic qsc-bin autodetect, with CI dry-run regression guard — `qsl/qsl-client/qsc/scripts/remote_soak.py`; `qsl/qsl-client/qsc/REMOTE_SOAK_PLAYBOOK.md`; `qsl/qsl-client/qsc/tests/remote_soak_state_root_na0167.rs`; `DECISIONS.md` — PR TBD, Decision D-0268.
