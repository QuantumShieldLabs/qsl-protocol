...
- 2026-01-10: Audit Issue #7 hardening — ratchet_encrypt no-mutation on failed send + regression guard test (tests/AUDIT-20260104_issue7_send_state_no_mutation_testplan.md) (PR #TBD).
