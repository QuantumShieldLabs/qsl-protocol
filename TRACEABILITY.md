...
- NA-0156 READY — bounded receive work (header-decrypt attempt caps + normalized rejects + no-mutation proofs) — `tools/refimpl/quantumshield_refimpl/src/suite2/ratchet.rs` (unit tests: `recv_invalid_message_caps_header_attempts`, `recv_far_future_message_fails_fast_without_mutation`, `nonboundary_header_breaks_on_first_success`) — PR TBD, Decision D-0263.
