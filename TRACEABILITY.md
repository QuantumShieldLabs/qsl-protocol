...
- 2026-01-11: Audit Issue #16 hardening — bounded suite2 restore_bytes parsing; regression guards; testplan `tests/AUDIT-20260104_issue16_deser_dos_bounds_testplan.md` (PR #TBD).
