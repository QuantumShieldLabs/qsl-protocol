...
- NA-0174 READY — mock relay regression guards for Content-Length conflict/truncated body handling (tests-only) — planned focus: `qsl/qsl-client/qsc/tests/common/mod.rs` contract comments and deterministic malformed-input regression tests in `qsl/qsl-client/qsc/tests/**`.
