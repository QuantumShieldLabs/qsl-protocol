...
- NA-0154 READY — handshake security closure proofs with mandatory ephemeral DH mixing for FS + identity-binding/downgrade regression guards — `qsl/qsl-client/qsc/src/main.rs`; `qsl/qsl-client/qsc/tests/handshake_mvp.rs`; `qsl/qsl-client/qsc/tests/handshake_security_closure.rs`; `tools/refimpl/quantumshield_refimpl/tests/suite2_handshake_security.rs`; `DECISIONS.md` — PR TBD, Decision D-0261.
