...
- NA-0168 implementation — soak harness overload classification and bounded retry/backoff with observability counters (`overload_retries`, `overload_failures`) + deterministic dry-run simulation proof — `qsl/qsl-client/qsc/scripts/remote_soak.py`; `qsl/qsl-client/qsc/tests/remote_soak_backpressure_na0168.rs`; `DECISIONS.md` — PR #449 (https://github.com/QuantumShieldLabs/qsl-protocol/pull/449), merge SHA `475d8d5b927897ac0f4cc6ac3622bc17fd9f46b6`, Decision D-0269.
- NA-0168 implementation (send-readiness + responder-first-reply unblock) — non-mutating `send_ready`/`send_ready_reason` markers on handshake status, safe `qsp_pack_failed` reason classification, establish-time dual-direction chain initialization for responder-first-reply, and soak diag send gating with bounded readiness retries + deterministic fail code `session_not_send_ready` — `tools/refimpl/quantumshield_refimpl/src/suite2/establish.rs`; `qsl/qsl-client/qsc/src/main.rs`; `qsl/qsl-client/qsc/scripts/remote_soak.py`; `qsl/qsl-client/qsc/tests/send_ready_markers_na0168.rs`; `qsl/qsl-client/qsc/tests/remote_soak_diag_mapping_na0168.rs`; `qsl/qsl-client/qsc/tests/remote_soak_diag_na0168.rs`; `qsl/qsl-client/qsc/tests/remote_soak_mode_na0168.rs`; `DECISIONS.md` — PR #450 (https://github.com/QuantumShieldLabs/qsl-protocol/pull/450), Decisions D-0270, D-0271.
