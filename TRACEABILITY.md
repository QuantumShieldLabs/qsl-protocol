...
- 2026-01-11: Audit Issue #13 hardening — SCKA monotonicity reject + regression guards; testplan `tests/AUDIT-20260104_issue13_scka_monotonicity_testplan.md` (PR TBD).
