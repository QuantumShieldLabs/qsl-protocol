...
- NA-0142 follow-up — perf hardening: event-driven cache + vault session + no vault/KDF on nav/idle regression guard — `qsl/qsl-client/qsc/src/main.rs`; `qsl/qsl-client/qsc/src/vault.rs`; `qsl/qsl-client/qsc/tests/tui_perf_no_vault_on_nav.rs` — PR TBD.
