...
- NA-0172 READY — process guardrails follow-on: queue successor requirement + CI dependency policy (docs-only) — target files include `qsl-protocol/AGENTS.md` and CI dependency notes for scripts/docs.
