...
- 2026-01-09: Audit Issue #5 hardening — AEAD seal fail-closed (no panic) + regression guard testplan (tests/AUDIT-20260104_issue5_aead_no_panic_testplan.md) (PR #TBD).
