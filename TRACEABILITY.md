...
- NA-0149 implementation (client-only) — Messages UX MVP (`/msg "<text>"`, thread visibility rules, transcript rendering, deterministic scroll/send/reject tests) — `qsl/qsl-client/qsc/src/main.rs`; `qsl/qsl-client/qsc/tests/tui_messages_ux_mvp.rs`; `qsl/qsl-client/qsc/tests/tui_messages_contacts.rs`; `qsl/qsl-client/qsc/tests/tui_command_catalog_invariants.rs` — PR #415 (https://github.com/QuantumShieldLabs/qsl-protocol/pull/415).
