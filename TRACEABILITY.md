...
- NA-0156 READY — bounded receive work (header-decrypt attempt caps + normalized rejects + no-mutation proofs) — `tools/refimpl/quantumshield_refimpl/src/suite2/ratchet.rs`; `tools/refimpl/quantumshield_refimpl/tests/suite2_bounded_receive.rs` — PR TBD, Decision D-0263.
