...
- NA-0175 READY — mock relay transport contract additional deterministic negative cases (tests-only) — planned focus: `qsl/qsl-client/qsc/tests/common/mod.rs` and deterministic raw-socket negative tests in `qsl/qsl-client/qsc/tests/**` for chunked transfer rejection and second-request connection behavior.
