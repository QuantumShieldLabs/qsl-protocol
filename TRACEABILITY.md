...
- NA-0173 READY — test-harness transport stability in qsc local mock relay for macOS determinism (tests-only) — planned focus: `qsl/qsl-client/qsc/tests/common/mod.rs` (`start_inbox_server`, `handle_conn`, request parsing, connection lifecycle) and deterministic transport regression guard(s) in `qsl/qsl-client/qsc/tests/**`.
