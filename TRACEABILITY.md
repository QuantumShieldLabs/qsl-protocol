...
- NA-0160 implementation — macOS CI build lane for qsc + qshield-cli — `.github/workflows/macos-build.yml` — PR #437 (https://github.com/QuantumShieldLabs/qsl-protocol/pull/437).
