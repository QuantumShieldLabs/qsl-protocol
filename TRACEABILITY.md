...
- NA-0140 implementation — command output routing + settings cleanup — `qsl/qsl-client/qsc/src/main.rs`; `qsl/qsl-client/qsc/tests/tui_command_output_routing.rs` — PR TBD (this PR).
