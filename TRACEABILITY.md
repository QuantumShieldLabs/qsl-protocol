...
- NA-0171 READY — targeted macOS CI flake elimination for `contacts_verify_block::pinned_mismatch_refuses_no_mutation` (`relay_inbox_push_failed`) — focus area `qsl/qsl-client/qsc/tests/**`, especially contacts verify harness isolation.
