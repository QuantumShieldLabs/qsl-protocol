# DOCS_MAP — Documentation map and inventory (no deletions) v1.0.0 DRAFT

Goals: G4

## Policy: no deletions or moves without review

Do not delete or move documentation until:
1) We produce an inventory,
2) We confirm cross-links/traceability dependencies, and
3) We receive explicit approval for removals.
...
docs/README.md
docs/_external/.gitignore
docs/_external/PHASE2_CANONICAL.pointer.json
docs/_external/PHASE3_SUPPORTING.pointer.json
...
docs/review/DOC-REV-001_Signal_Comparative_Review_v1.0.0_DRAFT.md
...
docs/spec-closure/DOC-SCL-003_Conformance_Checklist_v1.0_DRAFT.md
docs/spec-closure/DOC-SCL-004_State_Persistence_Crash_Safety_v1.0_DRAFT.md
docs/test/DOC-TST-005_Suite-2_Conformance_Vector_Categories_v1.0.0_DRAFT.md
