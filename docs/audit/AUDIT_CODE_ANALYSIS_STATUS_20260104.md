...
| #12 | MEDIUM | take_mk_skipped leaves stale mk_order | tools/refimpl/quantumshield_refimpl/src/qsp/state.rs | FIXED (guarded) | Code: qsp/state.rs:111-115; Tests: take_mk_skipped_removes_from_mk_order / take_mk_skipped_on_missing_does_not_corrupt_order (state.rs); PR #TBD |
