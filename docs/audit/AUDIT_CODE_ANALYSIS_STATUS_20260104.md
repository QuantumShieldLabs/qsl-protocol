...
| #4 | HIGH | Weak RNG initialization | tools/refimpl/quantumshield_refimpl/src/crypto/stdcrypto.rs | FIXED (guarded) | Code: stdcrypto.rs:64-112 (OsRng); Test: x25519_keypair_uses_os_rng / random_nonce12_not_all_zero (stdcrypto.rs); PR #TBD |
