...
| #7 | HIGH | State mutation before send completion | tools/refimpl/quantumshield_refimpl/src/qsp/ratchet.rs | FIXED (guarded) | Code: ratchet.rs:190-260; Test: ratchet_encrypt_rejects_deterministically_and_no_state_mutation (ratchet.rs:457-476); PR #TBD |
