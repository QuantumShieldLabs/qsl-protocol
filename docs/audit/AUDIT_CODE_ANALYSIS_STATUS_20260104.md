...
| #24 | LOW | Hardcoded ZERO32 initialization | tools/refimpl/quantumshield_refimpl/src/suite2/establish.rs | FIXED (guarded) | Code: ratchet.rs:347-356, 692-693; Tests: send_wire_rejects_unset_chainkey_deterministically_and_no_mutation (ratchet.rs:1324-1337); PR #TBD |
