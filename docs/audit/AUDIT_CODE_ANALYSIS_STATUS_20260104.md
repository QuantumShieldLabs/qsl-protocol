...
| #18 | MEDIUM | Unsafe unwraps in OPK handling | tools/refimpl/quantumshield_refimpl/src/qsp/handshake.rs | FIXED (guarded) | Code: handshake.rs:92-113; Tests: opk_partial_bundle_rejects_deterministically_and_no_mutation / opk_bundle_with_both_present_succeeds (handshake.rs:415-466); PR #TBD |
