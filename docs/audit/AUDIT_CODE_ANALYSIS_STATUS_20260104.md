...
| #6 | HIGH | ck_pq_recv not updated on boundary | tools/refimpl/quantumshield_refimpl/src/suite2/ratchet.rs | FIXED (guarded) | Code: suite2/ratchet.rs:365-412; Tests: boundary_reject_is_deterministic_and_no_state_mutation_on_bad_ct_len / boundary_success_advances_ck_pq_recv_from_reseed (ratchet.rs:685-744); PR #TBD |
