...
| #16 | MEDIUM | DoS via large collection deserialization | tools/refimpl/quantumshield_refimpl/src/suite2/state.rs | FIXED (guarded) | Code: suite2/state.rs:86-213; Tests: restore_bytes_rejects_oversize_lengths_deterministically / restore_bytes_rejects_truncated_buffers_deterministically (suite2/state.rs:333-364); PR #TBD |
