...
| #10 | MEDIUM | Timing side-channel in header decryption | tools/refimpl/quantumshield_refimpl/src/qsp/ratchet.rs; suite2/ratchet.rs | FIXED (guarded) | Code: qsp/ratchet.rs:145-187; suite2/ratchet.rs:205-260; Tests: header_decrypt_attempts_all_candidates_even_on_first_success / header_decrypt_rejects_deterministically_and_no_state_mutation (qsp/ratchet.rs); nonboundary_header_attempts_all_candidates_even_on_first_success / nonboundary_rejects_deterministically_and_no_state_mutation (suite2/ratchet.rs); PR #TBD |
