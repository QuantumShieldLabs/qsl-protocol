...
| #21 | MEDIUM | MKSKIPPED removal without recovery | tools/refimpl/quantumshield_refimpl/src/suite2/ratchet.rs | FIXED (guarded) | Code: suite2/ratchet.rs:277-306; Tests: issue21_mkskipped_not_removed_on_auth_fail (suite2/ratchet.rs:1219-1248); PR #TBD |
