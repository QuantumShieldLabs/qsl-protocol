...
| #15 | MEDIUM | DH ratchet corrupts pn on ns overflow | tools/refimpl/quantumshield_refimpl/src/qsp/ratchet.rs | FIXED (guarded) | Code: ratchet.rs:87-138; Tests: dh_ratchet_rejects_on_ns_overflow_deterministically_and_no_state_mutation / dh_ratchet_success_near_boundary_does_not_corrupt_pn (ratchet.rs:522-549); PR #TBD |
