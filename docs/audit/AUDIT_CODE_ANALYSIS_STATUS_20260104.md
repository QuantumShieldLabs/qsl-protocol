...
| #17 | MEDIUM | Multiple unwraps on header_pt | tools/refimpl/quantumshield_refimpl/src/suite2/ratchet.rs | FIXED (guarded) | Code: suite2/ratchet.rs:345-372; Tests: header_pt_invalid_rejects_deterministically_and_no_state_mutation / header_pt_invalid_does_not_panic (suite2/ratchet.rs:775-805); PR #TBD |
