...
- The umbrella report remains authoritative only for the residual items not superseded by focused audits, now normalized as resolved `F02` plus still-live `F03`, `F11`, `F12`, `F13`, and `F14`.
