...
### ENG-0044 — GUI phase: restore the three TUI-only vault/account-protection features co-deleted with the TUI (failed-unlock attempt-limit, idle autolock, account-destroy) — **NEW; filed 2026-07-14 by NA-0645 (D-1268; directive D581) — OWED to the GUI phase**
...
### ENG-0046 — qsl-protocol: bump the qsl-server dev-dep pin past the NA-0652 server-info merge and re-run the NA-0640 full-stack e2e locally — **NEW; filed 2026-07-17 by NA-0652 (D-1275; directive D588) — OWED FOLLOW-UP (the ENG-0041/D579 shape)**
...
- Status: open — filed 2026-07-17 at the NA-0652 closeout; D588 forbade the bump in-lane (a pin bump is a DELIBERATE, SEPARATE step per the NA-0640 discipline)
