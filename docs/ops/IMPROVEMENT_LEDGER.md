...
- Status: open — filed 2026-07-20 by NA-0663 (D-1287; provenance: the NA-0663 post-merge STOP response §6, and the operator ruling of 2026-07-20 directing this filing). FILING ONLY; not executed in-lane — `.github/**` is on the D599 FORBIDDEN list and any remediation is a separate, deliberate lane. Cross-reference **ENG-0050** (the fmt/clippy validation-default hazard): both are CI-configuration debt surfaced by this same lane — one where the stated gates do not exist, one where the gates that do exist had not run.

### ENG-0053 — `relay_ca_file()` performs a vault read on EVERY client construction: ~350-400 ms per relay operation, compounding as the vault store grows
...
- Status: open — filed 2026-07-21 by NA-0663 (D-1287; provenance: this lane's five measurement responses, 2026-07-20/21). FILING ONLY; not executed in-lane — any remedy is a source change and forbidden to NA-0663.
