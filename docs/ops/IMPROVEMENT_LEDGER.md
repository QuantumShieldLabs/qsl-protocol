...
- Status: open — filed 2026-07-22 by NA-0666 (D-1292); **sequencing corrected and the deadline recorded 2026-07-22 by NA-0667 (D-1293).** **The move is still a desktop PR and NA-0667 did NOT make it.** **The four files were NOT moved, copied, or edited by NA-0666 or NA-0667** — they remain at the `/srv/qbuild/tmp/` path recorded above, and that is precisely the risk.
