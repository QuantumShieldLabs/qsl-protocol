...
- Cross-reference: ENG-0095 (the barrier that made the direct path safe); ENG-0043 (the lease default this depends on); ENG-0083 (in-flight ratchet state persisted in two places — the same two-path split, seen from the storage side); D622 STOP 008/009.
