...
- Status: open — the corrective is the crash-window fault-injection harness scoped as NEXT_ACTIONS ON DECK item 0c (its own directive, LITE); this finding names the exercise, per the WF-0019 standard
...
- Ref: NA-0638; D-1261; directive `QSL-DIR-2026-07-12-574` (D574); WF-0019; WF-0005; ENG-0004 (closed, stays closed); NA-0609D (D-1216); `docs/governance/evidence/NA-0638_as_built.md` §2 (claims 7/8 rows), §4, §5; NEXT_ACTIONS ON DECK 0c.
