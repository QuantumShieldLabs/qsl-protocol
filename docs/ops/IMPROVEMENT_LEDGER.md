...
- Status: open — the corrective is the scoped NA-0609B coverage re-examination (NEXT_ACTIONS ON DECK item 0a, successor lane, its own directive) plus the constructive standard below; closes when the re-examination lane lands (or as the operator directs)
