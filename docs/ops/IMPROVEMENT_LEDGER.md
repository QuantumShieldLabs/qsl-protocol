...
- Status: open — **filed 2026-07-11** by the NA-0632 internal adversarial re-analysis (directive D569); a finding, FILED not fixed (analysis-lane rule). Full report: `docs/governance/evidence/NA-0632_adversarial_reanalysis.md` §2; mechanical probe: `docs/governance/evidence/NA-0632_sig_pin_probe.sh`; proof-of-issue test spec: `tests/NA-0632_adversarial_reanalysis_testplan.md` §B. Last-updated 2026-07-11.
