...
- Status: open — filed 2026-07-22 by NA-0666 (D-1292) at operator direction. **FILING ONLY — the fix is lane (b), and this item's resolution shapes what lane (b) can even attempt.**
...
- Status: open — filed 2026-07-22 by NA-0666 (D-1292) at operator direction. **FILING ONLY — the move is a desktop/tooling lane.** **The four files were NOT moved, copied, or edited by this lane** — they remain at the `/srv/qbuild/tmp/` path recorded above.
