...
- qsl-protocol Packet E branch: `na-0288-metadata-phase2-external-review-gap-plan`
- qsl-protocol Packet E head: `121e8d39b64c`
- qsl-protocol Packet E merge/main: `be8eb172f415`
- qsl-protocol Packet F branch: `na-0288-closeout-restore-na0289`
- qsl-protocol Packet F head: pending
- qsl-protocol origin/main at Packet F start: `be8eb172f415`
- qsl-protocol mirror/main: `2abcee236e23`
...
- Packet E PR: #829
- Packet E merge commit: `be8eb172f415`
- Packet F branch: `na-0288-closeout-restore-na0289`
- Packet F PR: pending
- Packet F merge commit: pending
...
- Post-merge public-safety status for Packet E returned a non-zero status while `public-safety` was missing and adjacent checks were still in progress. Classification: recoverable pending-check attach window. Corrective action: used bounded REST polling on merge `be8eb172f415`. Final result: `public-safety` attached and completed success.
...
- Packet E PR #829 merged normally as `be8eb172f415` from validated head `121e8d39b64c`; PR checks completed success, including `public-safety` and `CodeQL`.
- Packet E post-merge main public-safety completed success on `be8eb172f415`; docs-only cost-control skipped heavy Linux/macOS full-suite jobs as expected.
- Packet F closeout is in progress to mark NA-0288 DONE and restore NA-0289 as the sole READY successor for external review package refresh and claim-boundary alignment.
...
- Directive: `QSL-DIR-2026-05-09-052 — Packet D NA-0256 Closeout and NA-0257 Restoration`
- Begin timestamp (America/Chicago): 2026-05-09T00:04:30-05:00
- Begin timestamp (UTC): 2026-05-09T05:04:30Z
- Entry timestamp (America/Chicago): 2026-05-09T01:35:03-05:00
- Entry timestamp (UTC): 2026-05-09T06:35:03Z

## Repo SHAs

- qsl-protocol branch: `na-0256-closeout-restore-na0257`
- qsl-protocol base/origin/main: `e6f6362e6595`
- Packet B PR `#762` validated head: `b16ffca35618`
- Packet B PR `#762` merge commit: `e6f6362e6595`
- Post-merge main `public-safety`: success on `e6f6362e6595`

## READY proof

- Pre-closeout READY_COUNT: `1`
- Pre-closeout sole READY item: `NA-0256 — Public Demo and Desktop Touch-and-Feel Readiness Hardening`
- D-0479 existed once before closeout.
- D-0480 was absent before closeout.
- Duplicate decision count was zero.

## Worktree / branch / PR

- Worktree path: `/srv/qbuild/work/NA-0256/qsl-protocol`
- Branch: `na-0256-closeout-restore-na0257`
- Closeout PR: pending at authoring time
- Merge commit: pending at authoring time

## What changed

- Verified Packet B PR `#762` merged normally as `e6f6362e6595` from validated head `b16ffca35618`.
- Verified post-merge main `public-safety`, `qsc-linux-full-suite`, `macos-qsc-full-serial`, and `qsc-adversarial-smoke` completed success on `e6f6362e6595`.
- Marked NA-0256 DONE and restored NA-0257 as the sole READY cross-host / Tailscale public demo reproducibility successor.
- Added D-0480, TRACEABILITY closeout evidence, and `tests/NA-0256_closeout_restore_na0257_testplan.md`.
- No `.github`, scripts, Cargo, qsc/qsl runtime, qsc-desktop, apps, tools, inputs, formal, qsl-server, qsl-attachments, website, external website, protocol, crypto, demo implementation, service implementation, branch-protection, or public-safety configuration path has been changed.
...
- Keep closeout changed paths inside the Packet D allowlist.
- Merge only by validated head SHA, with merge commit, no squash/rebase, no direct push, no branch-protection exception, and no admin bypass.
- Do not implement NA-0257 in this directive.
...
- Directive: `QSL-DIR-2026-05-07-040 — NA-0252B CodeQL Taint-Isolated Leak-Scan Metadata Fix, Resume PR #754, Merge If Green, Optional NA-0252 Closeout to NA-0253`
- Begin timestamp (America/Chicago): 2026-05-07T00:18:30-05:00
- Begin timestamp (UTC): 2026-05-07T05:18:30Z
- Entry timestamp (America/Chicago): 2026-05-07T05:49:11-05:00
- Entry timestamp (UTC): 2026-05-07T10:49:11Z
- End timestamp (America/Chicago): pending
- End timestamp (UTC): pending
...
- qsl-protocol Packet A branch: `na-0252-repo-local-evidence-helper`
- qsl-protocol PR #754 initial head for this directive: `6c406b961b0d`
- qsl-protocol origin/main before edits: `9867d0d8ba4d`
- PR #753 merge: `9867d0d8ba4d`
- PR #752 merge: `e569599db9fe`

## READY proof

- READY_COUNT on `origin/main` before edits: `1`
- Sole READY item on `origin/main` before edits: `NA-0252 — Repo-Local Evidence and CI Recovery Helper Toolkit`
- D-0110 and D-0439 through D-0470 existed once on `origin/main`.
- D-0471 was absent on `origin/main`; D-0471 exists once on PR #754 branch.
- D-0472 was absent before edits.
- Latest main public-safety on `9867d0d8ba4d` completed successfully.
...
- Packet A removes `SCAN_LINE_COUNT` from leak-scan output.
- Packet A removes the returned scan-line count from the function that inspects secret-bearing source lines.
- Packet A adds a static-rule secret detection helper so findings contain only rule, path, and line metadata.
- Packet A updates the audit, testplan, D-0471, TRACEABILITY, and this journal entry to record CodeQL taint isolation and the temporary fake-secret regression.
- Packet A does not edit `NEXT_ACTIONS.md`; `NA-0252` remains READY pending closeout.

## Failures / recoveries

- Failing command: `apply_patch` for `docs/governance/evidence/NA-0252_repo_local_evidence_helper_audit.md`.
- Classification: recoverable patch-shape/context issue.
- Cause: the patch context included rendered line numbers from inspection output rather than the file text.
- Corrective action: reran the patch against direct file text.
- Final result: audit updated with CodeQL taint-isolation wording.

## Validation / CI notes

- Pre-edit proof:
  - origin/main matched expected `9867d0d8ba4d`
  - PR #754 was open at expected head `6c406b961b0d`
  - PR #753, #752, #751, #749, #748, #747, #746, and #708 were merged
  - PR #750 and #722 were closed and unmerged
  - branch protection required `public-safety` plus the expected required contexts
  - force pushes and deletions were disabled; admin enforcement was enabled
  - latest main `public-safety` completed successfully
  - CodeQL check-run annotation for PR #754 reported one in-scope finding at `scripts/ci/qsl_evidence_helper.py` line 566: clear-text logging of sensitive information
- Local Packet A validation passed:
  - `git diff --check` passed
  - `python3 -m py_compile scripts/ci/qsl_evidence_helper.py` passed
  - helper `--help` listed all required subcommands
  - helper queue parser and canonical queue parser reported `READY_COUNT 1`, sole READY `NA-0252`
  - helper decision parser and canonical decision parser reported D-0471 once, D-0472 absent, duplicate count zero
  - helper link-check and manual markdown link-integrity reported `TOTAL_MISSING 0`
  - helper full-file and added-line leak scans reported `SECRET_FINDING_COUNT 0` and did not print `SCAN_LINE_COUNT`
  - temporary fake-secret regression reported a `github_token` finding with `redaction=[redacted]`, exited nonzero for the finding, and did not print the generated fake marker, large distinguishing substring, or `SCAN_LINE_COUNT`
  - committed-text scan confirmed the prior static fake-token marker is absent
  - scope guard reported `CHANGED_PATH_COUNT 6`, all paths allowed, and `FORBIDDEN_COUNT 0`
  - valid PR body preflight passed and invalid PR body preflight failed with the expected missing fields
  - helper checks-summary for PR #752 reported required context failure count zero in report-only mode
  - helper public-safety-status reported latest main public-safety success and no ambiguity
  - helper ci-admission-preflight for PR #752 reported no circular dependency risk
  ...
  - `scripts/ci/demo_cli_smoke.sh` passed with `DEMO_ACCEPTANCE_OK`
  - `scripts/ci/metadata_conformance_smoke.sh` passed with `metadata-conformance-smoke: OK`
  - non-fatal validation warnings: cargo package-cache lock waits during concurrent smoke commands and the existing demo-only unauthenticated-establish warning from metadata conformance
- Post-commit validation:
  - local commit created with message `NA-0252 isolate leak-scan metadata`
  - committed head recorded in final evidence after amend
  - committed-head diff name-only listed exactly the six Packet A allowed paths
  - committed-head `git diff --check origin/main...HEAD` passed
  - committed-head synthetic-event goal-lint passed
  - committed-head helper script contains no `SCAN_LINE_COUNT` output path
- Pending:
  - push, required CI polling, merge if green, post-merge public-safety proof, optional closeout, and read-only forward audit.
...
- qsl-protocol worktree path: `/srv/qbuild/work/NA-0325/qsl-protocol`
- qsl-protocol branch: `na-0325-metadata-runtime-timing-traffic-mitigation-option-matrix`
- qsl-protocol HEAD at branch start: `625375b72fcf`
- qsl-protocol origin/main at startup: `625375b72fcf`
- qsl-protocol mirror/main at startup: `2abcee236e23`

## READY proof

- READY_COUNT at start after switching to refreshed origin/main: `1`
- Sole READY item at start: `NA-0325 -- Metadata Runtime Timing and Traffic-Shape Mitigation Option Matrix`
- Decision proof at start: latest D-0631, D-0630 once, D-0631 once, D-0632 absent, duplicate count zero
...
- Startup timestamps: local `2026-05-20T17:26:50-05:00`; UTC `2026-05-20T22:26:50+00:00`.
...
- Branch protection required `public-safety`; force pushes disabled; deletions disabled; admins enforced.
- Startup public-safety passed on `625375b72fcf`.
- Startup dependency health passed: `cargo audit --deny warnings`; `rustls-webpki v0.103.13`.
...
- Startup timestamps: local `2026-05-18T15:42:18-05:00`; UTC `2026-05-18T20:42:18+00:00`.
...
- qsl-protocol HEAD: `ae73cd0d80ae`
...
- Post-merge decision-count proof first combined a pipe with a Python heredoc and exited with a broken-pipe shape. Classification: recoverable local evidence command-shape issue. Corrective action: reran the post-merge proof with zero-failure-safe command substitutions against fetched `origin/main`. Final result: D-0568, D-0569, and D-0570 each existed once on `d181531ee7e2`, D-0571 was absent before closeout, and READY remained NA-0297.
...
- PR #853 protected checks completed with 29 successes and 9 docs-only skips; `public-safety` completed success before merge.
- PR #853 merged normally with `--merge --match-head-commit ae73cd0d80ae`; no delete-branch flag was used.
- Post-merge main `public-safety` completed success on `d181531ee7e2`; main-push checks completed with 34 successes and 2 skips.
...
- Packet H closeout is allowed after PR #853 merged, post-merge `public-safety` was green, READY remained NA-0297, and D-0570 existed once.
- Restore NA-0298 as operator-action / implementation blocker resolution, not website implementation.

---

# Rolling Operations Journal Entry

- Directive: QSL-DIR-2026-05-16-104 - NA-0297 closeout and NA-0298 restoration
- Begin timestamp (America/Chicago): 2026-05-16T02:58:30-05:00
- Begin timestamp (UTC): 2026-05-16T07:58:30Z
- End timestamp (America/Chicago): pending
- End timestamp (UTC): pending
...
- qsl-protocol branch: `na-0297-closeout-restore-na0298`
- qsl-protocol HEAD: pending
- qsl-protocol origin/main: `d181531ee7e2`
- Packet G PR #853 head: `ae73cd0d80ae`
- Packet G PR #853 merge/main: `d181531ee7e2`

## READY proof

- READY_COUNT: 1
- Sole READY item before closeout: NA-0297 - Website Source Verification Follow-Up and Implementation Blocker Resolution
- Proof source: fetched qsl-protocol `origin/main` after PR #853 merge

## Worktree / branch / PR

- Worktree path: `/srv/qbuild/work/NA-0297/qsl-protocol`
- Branch: `na-0297-closeout-restore-na0298`
- PR: pending
- Merge commit: pending

## Failures / recoveries

- None yet beyond Packet G recoveries above.

## Validation / CI notes

- Packet G source/deploy classification: `OPERATOR_ACTION_REQUIRED`.
- Packet G claim/link scan readiness: `PARTIAL_READY_NEEDS_SOURCE`.
- Closeout validation passed before PR creation: `git diff --check`; changed-line overclaim scan with allowed/negated matches only; queue READY `NA-0298`; decisions latest `D-0571` with duplicate count zero; D-0570 and D-0571 each existed once; D-0572 was absent; scope guard allowed all five changed paths; link-check `TOTAL_MISSING 0`; added leak scan `SECRET_FINDING_COUNT 0`; `cargo audit --deny warnings`; `cargo tree -i rustls-webpki --locked`; `cargo +stable test -p qsc --locked --test send_commit -- --test-threads=1`; `python3 formal/run_model_checks.py`; synthetic-event goal-lint; and changed-path classifier `docs_only=true`.
...
- Merge closeout only if required checks complete normally and public-safety remains required/green.
- PR #846 merged as `820b3791e118`; post-merge `public-safety` completed success. Remote closeout head branch deletion was observed only as GitHub platform auto-cleanup after merge.
- Command-shape recovery: the first post-merge polling loop used a malformed Python f-string inside shell quoting while printing the public-safety field. Classification: recoverable command-shape/polling-output issue because total/in-progress/failure counters were still valid and no repository mutation depended on the bad field. Corrective action: terminated the faulty polling loop and reran `python3 scripts/ci/qsl_evidence_helper.py public-safety-status --sha 820b3791e118ba472ec9eb4365cdd0b1ad7db375 --repo QuantumShieldLabs/qsl-protocol`. Final result: `public-safety` completed success, red=no, ambiguous=no; docs-only full suites were skipped as expected.
...
- Proof source: qsl-protocol `origin/main` `NEXT_ACTIONS.md`
...
- Startup guard: qsl-protocol `origin/main` matched `0f7c8ca03b3a`; qsl-protocol worktree clean; public-safety required and green; READY_COUNT 1 with READY NA-0285; D-0539 present once; D-0540 absent.
