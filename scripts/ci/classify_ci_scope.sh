...
is_docs_path() {
  ...
  case "$1" in
    NEXT_ACTIONS.md|TRACEABILITY.md|DECISIONS.md|STATUS.md|README.md|START_HERE.md|SECURITY.md|SUPPORT.md|CONTRIBUTING.md|CODE_OF_CONDUCT.md|THIRD_PARTY_NOTICES.md|LICENSE|docs/*)
      return 0
      ;;
    *)
      return 1
