...
# NA-0235A Scope Repair V3 Testplan

## Purpose

This docs-only testplan records the validation checkpoints for the `NA-0235A` governance scope repair v3.

## Validation Checkpoints

- Local goal-lint passes for the governance-only scope-repair v3 PR.
...
- Archive evidence doc: `docs/archive/testplans/NA-0235A_scope_repair_qsl_attachments_test_harness_evidence.md`
- Repaired queue block: `NEXT_ACTIONS.md` `NA-0235A — Runtime Dependency Advisory Remediation for Public-Safety Unblock`
- Decision entry: `DECISIONS.md` `D-0413`
- Traceability entry: `TRACEABILITY.md` `NA-0235A scope repair v3`
- Rolling journal entry: `docs/ops/ROLLING_OPERATIONS_JOURNAL.md` entry for Directive 304

## Acceptance Checkpoints

- The scope repair is governance-only and does not modify runtime code, runtime tests, manifests, lockfiles, `apps/qsl-tui/**`, `qsl-attachments/**`, `.github`, website/public-runtime, qsc-desktop, or qsl-server.
