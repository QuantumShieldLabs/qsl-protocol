...
# NA-0235A Scope Repair V5 Testplan

## Purpose

This docs-only testplan records the validation checkpoints for the `NA-0235A` governance scope repair v5.

## Validation Checkpoints

- Local goal-lint passes for the governance-only scope-repair v5 PR.
...
- Archive evidence doc: `docs/archive/testplans/NA-0235A_scope_repair_qsl_attachments_lockfile_evidence.md`
- Repaired queue block: `NEXT_ACTIONS.md` `NA-0235A — Runtime Dependency Advisory Remediation for Public-Safety Unblock`
- Decision entry: `DECISIONS.md` `D-0415`
- Traceability entry: `TRACEABILITY.md` `NA-0235A scope repair v5`
- Rolling journal entry: `docs/ops/ROLLING_OPERATIONS_JOURNAL.md` entry for Directive 308
