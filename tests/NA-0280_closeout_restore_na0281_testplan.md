...
# NA-0280 Closeout and NA-0281 Restoration Test Plan

## Objective

Validate that the closeout marks NA-0280 DONE after the qsl-server
rate/global-cap harness and qsl-protocol evidence PRs merged, then restores
exactly one READY successor, NA-0281, without implementing NA-0281.

## Protected invariants

- Exactly one READY item exists after closeout.
- READY item is NA-0281.
- NA-0280 is DONE.
- D-0530 exists once.
- D-0531 exists once.
...
- `tests/NA-0280_closeout_restore_na0281_testplan.md`
...
- READY is `NA-0281 — qsl-server Route Lifecycle / TTL / Retention Harness`.
- NA-0280 is DONE.
...
- Post-merge main has READY_COUNT `1`, READY NA-0281, NA-0280 DONE, D-0531
  present once, and public-safety required/green.
- NA-0281 remains future executable qsl-server route lifecycle / TTL /
  retention harness work and is not implemented inside the closeout.
