...
# NA-0325 Closeout Restore NA-0326 Testplan

## Objective

Close NA-0325 after PR #912 merged the metadata runtime timing and
traffic-shape mitigation option matrix, then restore exactly one READY
successor:

`NA-0326 -- Metadata Runtime qshield Demo Retry Cadence Normalization Authorization Plan`

This closeout must not implement NA-0326.

## Protected Invariants

- Exactly one READY item exists after closeout: NA-0326.
- NA-0325 is DONE.
- D-0632 exists once.
- D-0633 exists once.
- D-0634 is absent.
- Measurement remains distinct from mitigation.
- The NA-0325 option matrix is not presented as implemented mitigation.
...
## PR #912 Proof Requirements

1. PR #912 is merged.
2. PR #912 title is `NA-0325: add timing traffic mitigation option matrix`.
3. PR #912 merge commit is recorded.
4. PR #912 head commit is recorded.
5. PR #912 evidence remains bounded to option-matrix/design-only proof.

## Public-Safety Proof Requirements

1. `public-safety` completed success for the PR #912 merge commit.
...
1. Start state has READY_COUNT 1 and READY NA-0325.
2. End state has READY_COUNT 1 and READY NA-0326.
3. NA-0325 is DONE.
4. D-0632 exists once.
5. D-0633 exists once.
6. D-0634 is absent.
...
- Measurement remains distinct from mitigation.
- The option matrix is not runtime mitigation.
...
- direct decision-count proof for D-0632, D-0633, and D-0634
...
The restored NA-0326 lane should produce the authorization/design plan for
qshield embedded relay/demo retry-cadence normalization selected by NA-0325. It
must preserve the measurement-versus-mitigation boundary, keep qshield demo
evidence distinct from qsl-server/qsl-attachments production timing, and avoid
runtime implementation unless a later directive separately authorizes it.
