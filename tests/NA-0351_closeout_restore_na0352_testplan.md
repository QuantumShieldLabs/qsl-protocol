...
# NA-0351 Closeout and NA-0352 Restoration Test Plan

## Objective

Verify that NA-0351 closes only after the qsl-protocol authorization plan merges
with required checks green, and that the exact selected NA-0352 successor is
restored as the sole READY item without implementing NA-0352.
...
- NA-0351 is DONE.
- NA-0352 is READY.
- D-0684 and D-0685 each exist exactly once.
- D-0686 is absent.
...
- No NA-0352 implementation is included by closeout.
...
- `READY_COUNT 1`
- `READY NA-0352 Metadata Runtime Production Backup / Deploy / Rollback Implementation Harness`
- NA-0351 is marked DONE in `NEXT_ACTIONS.md`.
...
python3 scripts/ci/qsl_evidence_helper.py scope-guard --base origin/main \
  ...
  --allowed tests/NA-0351_closeout_restore_na0352_testplan.md
```
...
This closeout authorizes no NA-0352 implementation.
