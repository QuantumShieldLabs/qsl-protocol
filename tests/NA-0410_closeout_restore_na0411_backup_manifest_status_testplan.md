...
# NA-0410 Closeout / NA-0411 Restoration Testplan

## Purpose

Validate that NA-0410 closes only after qwork cwd-independent queue
verification evidence merged and post-merge public-safety completed success,
and that the preserved backup manifest/status lane is restored as NA-0411
...
- D-0806 exists exactly once.
- D-0807 exists exactly once.
...
- `tests/NA-0410_closeout_restore_na0411_backup_manifest_status_testplan.md`
...
- NA-0411 is restored only as the next READY lane; no NA-0411 implementation is
  performed.
